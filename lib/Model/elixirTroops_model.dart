...
ElixirTroopsModel elixirTroopsModelFromJson(String str) => ElixirTroopsModel.fromJson(json.decode(str));

String elixirTroopsModelToJson(ElixirTroopsModel data) => json.encode(data.toJson());
...
class ElixirTroopsModel {
  ...
  factory ElixirTroopsModel.fromJson(Map<String, dynamic> json) => ElixirTroopsModel(
