...
class DarkSpellsDetails extends StatelessWidget {
  DarkSpellsDetails({super.key});

  final controller = Get.put(DarkSpellsDetailsController());

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(controller.darkSpellsData[0].name),
      ),
            ...
            children: [
              ...
              SizedBox(
                ...
                child: Swiper(
                        ...
                        child: Center(
                          child: ClipRRect(
                            ...
                            child: CachedNetworkImage(
                              imageUrl: controller.darkSpellsData[0].mainimage,
                              fit: BoxFit.cover,
                              height: 100.r,
                  ...
                  itemCount: controller.darkSpellsData[0].details.length,
              ...
              BuildContainer.armyDetail(
                title: 'Description :',
                subtitle: controller.darkSpellsData[0].description,
              ),
