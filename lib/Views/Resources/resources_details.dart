...
class ResourcesDetails extends StatelessWidget {
  ResourcesDetails({super.key});

  final controller = Get.put(ResourcesDetailsController());

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(controller.resourcesData[0].name),
      ),
            ...
            children: [
              ...
              SizedBox(
                ...
                child: Swiper(
                      ...
                      Positioned(
                        child: Center(
                          child: CachedNetworkImage(
                            imageUrl: controller
                                .resourcesData[0].details[index].image,
                  ...
                  itemCount: controller.resourcesData[0].details.length,
              ...
              BuildContainer.buildCard(
                ...
                title: controller.resourcesData[0].cost,
                fontSize: 15.r,
                borderRadius: 16.r,
              ),
              10.h.verticalSpace,
              ...
              BuildContainer.buildCard(
                height: 60.r,
                width: double.infinity,
                title: controller.resourcesData[0].role,
                fontSize: 15.r,
                borderRadius: 16.r,
              ),
              ...
              BuildContainer.armyDetail(
                title: 'Description :',
                subtitle: controller.resourcesData[0].description,
              ),
