...
class PetsDetails extends StatelessWidget {
  PetsDetails({super.key});

  final controller = Get.put(PetsDetailsController());

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(controller.petsData[0].name),
      ),
            ...
            children: [
              ...
              SizedBox(
                ...
                child: Swiper(
                      ...
                      Positioned(
                        child: Center(
                          child: CachedNetworkImage(
                            imageUrl:
                                controller.petsData[0].details[index].image,
                            height: 100.r,
                            fit: BoxFit.cover,
                  ...
                  itemCount: controller.petsData[0].details.length,
              ...
              BuildContainer.buildCard(
                ...
                title: controller.petsData[0].cost,
                fontSize: 15.r,
                borderRadius: 16.r,
              ),
              ...
              BuildContainer.armyDetail(
                title: 'Description :',
                subtitle: controller.petsData[0].description,
              ),
